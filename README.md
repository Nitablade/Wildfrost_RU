# Russian localization for Wildfrost (by Nitablade)
EN:
...
Данная модификация работает только с официальной копией игры Wildfrost, доступной в Steam. 

Модификация никак не влияет на получений достижений в игре.
